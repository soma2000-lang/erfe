...
class RunwayDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Find coordinates in the CSV
        try:
            row = self.coordinates_df[self.coordinates_df['image'] == img_name + '.jpeg'].iloc[0]
            ...
            # Create mask
            mask = self.create_mask_from_coordinates((h, w), coordinates, class_id=1)
        ...
        # Prepare additional outputs if needed
        seg_mask = mask.float()  # Already in the right format from ToTensorV2
