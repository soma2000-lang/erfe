...
def process_dataset(onnx_model_path, image_paths, gt_json_path, output_dir, batch_size=8, threshold=0.5, use_gpu=True, save_pred: int = 50, apply_sigmoid:bool = True):
    ...
    for batch_idx in range(num_batches):
        ...
        # Postprocess batch
        binary_masks_batch = postprocess_masks(mask_logits_batch, threshold)
...
# Main execution
def main():
    onnx_model_path = "/home/AD/sthapa/segmentation_pipeline/grid_aero/grid_aero_models/Lards_model_exp8/model.onnx"
